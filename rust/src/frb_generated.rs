...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 1139984084;
...
fn wire__crate__api__simple__parse_flac_file_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
        ...
        move || {
            ...
            move |context| {
                transform_result_sse::<_, String>((move || {
                    let output_ok = crate::api::simple::parse_flac_file(api_path)?;
                    Ok(output_ok)
                })())
            }
        },
...
impl SseDecode for crate::api::simple::FlacAudioInfo {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        ...
        return crate::api::simple::FlacAudioInfo {
            title: var_title,
            artist: var_artist,
            album: var_album,
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        2 => wire__crate__api__simple__parse_flac_file_impl(port, ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
...
impl flutter_rust_bridge::IntoDart for crate::api::simple::FlacAudioInfo {
...
impl flutter_rust_bridge::for_generated::IntoDartExceptPrimitive
    for crate::api::simple::FlacAudioInfo
{
}
impl flutter_rust_bridge::IntoIntoDart<crate::api::simple::FlacAudioInfo>
    for crate::api::simple::FlacAudioInfo
{
    fn into_into_dart(self) -> crate::api::simple::FlacAudioInfo {
        self
    }
}
...
impl SseEncode for crate::api::simple::FlacAudioInfo {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {

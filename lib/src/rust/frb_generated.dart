...
abstract class RustLibApi extends BaseApi {
  ...
  Future<List<LyricLine>> crateApiAudioInfoAudioInfoParseLyrics({
    String? lyricRawContent,
  });

  Future<LyricFormat> crateApiAudioInfoDetectLyricFormat({
    required String content,
  });

  Future<AudioInfo> crateApiAudioInfoGetAudioInfo({required String path});

  Future<Uint8List?> crateApiAudioInfoGetExternalCover({
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<String> crateApiAudioDbDbManagerSaveQueueSnapshot({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        argValues: [that, songs, currentIndex, maxLimit, snapshotId, name],
        apiImpl: this,
      ),
    );
  }
  ...
  Future<List<LyricLine>> crateApiAudioInfoAudioInfoParseLyrics({
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          final serializer = SseSerializer(generalizedFrbRustBinding);
          sse_encode_opt_String(lyricRawContent, serializer);
          pdeCallFfi(
            generalizedFrbRustBinding,
            serializer,
            funcId: 24,
        ...
        constMeta: kCrateApiAudioInfoAudioInfoParseLyricsConstMeta,
        argValues: [lyricRawContent],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiAudioInfoAudioInfoParseLyricsConstMeta =>
      const TaskConstMeta(
        debugName: "audio_info_parse_lyrics",
        argNames: ["lyricRawContent"],
      );
  ...
  Future<LyricFormat> crateApiAudioInfoDetectLyricFormat({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_lyric_format,
          decodeErrorData: null,
        ),
        constMeta: kCrateApiAudioInfoDetectLyricFormatConstMeta,
        argValues: [content],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiAudioInfoDetectLyricFormatConstMeta =>
      const TaskConstMeta(
        debugName: "detect_lyric_format",
        argNames: ["content"],
      );
  ...
  Future<Uint8List?> crateApiAudioInfoGetExternalCover({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiAudioInfoGetExternalCoverConstMeta,
        argValues: [audioPath],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiAudioInfoGetExternalCoverConstMeta =>
      const TaskConstMeta(
        debugName: "get_external_cover",
        argNames: ["audioPath"],
      );
    ...
    unawaited(
      handler.executeNormal(
        NormalTask(
          ...
          constMeta: kCrateApiHotkeyInitNativeHotkeysConstMeta,
          argValues: [sink],
          apiImpl: this,
        ),
      ),
  ...
  TaskConstMeta get kCrateApiHotkeyInitNativeHotkeysConstMeta =>
  ...
  TaskConstMeta get kCrateApiMetadataReadMetadataConstMeta =>
      const TaskConstMeta(debugName: "read_metadata", argNames: ["dirPath"]);
  ...
  AudioInfo dco_decode_audio_info(dynamic raw) {
    ...
    return AudioInfo(
      ...
      lyricRawContent: dco_decode_opt_String(arr[5]),
    );
  }
  ...
  LyricLine dco_decode_lyric_line(dynamic raw) {
    ...
    return LyricLine(
      ...
      durationMs: dco_decode_i_32(arr[1]),
      text: dco_decode_String(arr[2]),
      words: dco_decode_list_lyric_word(arr[3]),
    );
  }
  ...
  LyricWord dco_decode_lyric_word(dynamic raw) {
    ...
    return LyricWord(
      ...
      startMs: dco_decode_i_32(arr[1]),
      endMs: dco_decode_i_32(arr[2]),
    );
  }
  ...
  QueueSnapshot dco_decode_queue_snapshot(dynamic raw) {
    ...
    return QueueSnapshot(
      id: dco_decode_String(arr[0]),
      name: dco_decode_String(arr[1]),
      songs: dco_decode_list_String(arr[2]),
      currentIndex: dco_decode_i_64(arr[3]),
  ...
  SongMetadata dco_decode_song_metadata(dynamic raw) {
    ...
    return SongMetadata(
      ...
      audioPath: dco_decode_String(arr[4]),
      lyricPath: dco_decode_opt_String(arr[5]),
  ...
  AudioInfo sse_decode_audio_info(SseDeserializer deserializer) {
    ...
    var var_lyricRawContent = sse_decode_opt_String(deserializer);
    return AudioInfo(
      title: var_title,
      artist: var_artist,
      album: var_album,
      ...
      lyricRawContent: var_lyricRawContent,
    );
  }
  ...
  LyricFormat sse_decode_lyric_format(SseDeserializer deserializer) {
    ...
    return LyricFormat.values[inner];
  }
  ...
  LyricWord sse_decode_lyric_word(SseDeserializer deserializer) {
    ...
    return LyricWord(text: var_text, startMs: var_startMs, endMs: var_endMs);
  }
  ...
  SongMetadata sse_decode_song_metadata(SseDeserializer deserializer) {
    ...
    var var_lyricPath = sse_decode_opt_String(deserializer);
    var var_coverPath = sse_decode_opt_String(deserializer);
    return SongMetadata(
      id: var_id,
      title: var_title,
  ...
  void sse_encode_audio_info(AudioInfo self, SseSerializer serializer) {
    ...
    sse_encode_opt_String(self.lyricRawContent, serializer);
  }
  ...
  void sse_encode_song_metadata(SongMetadata self, SseSerializer serializer) {
    ...
    sse_encode_opt_String(self.lyricPath, serializer);
    sse_encode_opt_String(self.coverPath, serializer);
  }
